...
Data Type: UNSIGNED TINY INT

Description: 'id' describes describes attributes which label information with autogenerated Numeric values ranging from 0-255. Examples include member_id, mentor_id, mentee_id, etc.
...
Description: 'description' describes attributes which label information with free-form descriptons. Examples include bio, scholarship, requirement, mission_statement desciptions.
